                         ...
                         {isDeleting ? (
                             <div className="absolute right-0 bottom-full mb-2 z-10 bg-white dark:bg-gray-800 p-2 rounded shadow-lg border border-gray-200 dark:border-gray-700 flex flex-col gap-2 min-w-[100px]">
                                 ...
                                 <div className="flex gap-1 justify-center">
                                     <button onClick={(e) => {e.stopPropagation(); setIsDeleting(false); onDelete(agent.id); }} className="bg-red-600 text-white text-[10px] px-2 py-1 rounded font-bold hover:bg-red-700 flex-1">Yes</button>
