...
export default function App() {
  ...
  const handleAddDeal = async (overrides?: Partial<Deal>) => {
      ...
      const newDealInit: Deal = {
          ...
          dateListed: null,
          renovationARV: 0,
          renovationARVToggle: true,
          newConstructionARV: 0,
          newConstructionARVToggle: false,
